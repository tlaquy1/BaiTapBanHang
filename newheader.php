...
<div class="wrapper">
    ...
    <!-- Navbar -->
 <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background: darkturquoise;">
        <!-- Left navbar links -->
        <ul class="navbar-nav">
            <li class="nav-item">
        ...
        <form class="form-inline ml-3" action="newindex.php" method="">
            <div class="input-group input-group-sm">
                ...
                placeholder="Search" aria-label="Search" name="timkiem" style="margin-top: 5px;">
